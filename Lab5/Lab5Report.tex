...
\pgfplotstableset{
    ...
    row sep=\\,
    every head row/.append style={after row=\endhead, before row=\caption{Job queue used to generate the \url{jimweller.com} dataset.}\\},
